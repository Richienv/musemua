...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-[#faf9f4] pt-24 sm:pt-32" aria-label="Platform Live Commerce #1 di Indonesia">
      <script
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col items-center">
            ...
            <motion.div
              ...
              className="text-center w-full max-w-5xl mx-auto mb-4 sm:mb-6 md:mb-8 px-2"
            >
              ...
              >
                {duplicatedStreamers.map((streamer, index) => (
                  <div
                    ...
                    className="flex-shrink-0 w-[calc((100vw-3rem)/1.5)] sm:w-[calc((100vw-8rem)/2)] md:w-[calc((100vw-8rem)/3)] min-w-[220px] sm:min-w-[280px] max-w-[400px] group"
                  >
